...
["<div style=display:flex><span>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:inline-flex><span>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-flex\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:flex><span>abc</span><span>def[]</span></div>ghi",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-flex><span>abc</span><span>def[]</span></div>ghi",
    [["forwarddelete",""]],
    "<div style=\"display:inline-flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:flex><span>abc</span><span>def[]</span></div><div>ghi</div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-flex><span>abc</span><span>def[]</span></div><div>ghi</div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["012[]<div style=display:flex><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "012abc<div style=\"display:flex\"><span>def</span></div>",
    [true],
    {}],
["012[]<div style=display:inline-flex><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "012abc<div style=\"display:inline-flex\"><span>def</span></div>",
    [true],
    {}],
["<div>012[]</div><div style=display:flex><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div>012abc</div><div style=\"display:flex\"><span>def</span></div>",
    [true],
    {}],
["<div>012[]</div><div style=display:inline-flex><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div>012abc</div><div style=\"display:inline-flex\"><span>def</span></div>",
    [true],
    {}],
["<div style=display:flex><span>abc</span><span>def[]</span></div><div style=display:flex><span>ghi</span><span>jkl</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abc</span><span>defghi</span></div><div style=\"display:flex\"><span>jkl</span></div>",
    [true],
    {}],
["<div style=display:inline-flex><span>abc</span><span>def[]</span></div><div style=display:inline-flex><span>ghi</span><span>jkl</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-flex\"><span>abc</span><span>defghi</span></div><div style=\"display:inline-flex\"><span>jkl</span></div>",
    [true],
    {}],
["<div style=display:flex><span>abc</span><span>def[]</span></div><div style=display:flex><span>ghi</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-flex><span>abc</span><span>def[]</span></div><div style=display:inline-flex><span>ghi</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-flex\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:flex><span>{}<br></span></div><div>abc</div>",
    [["forwarddelete",""]],
    "<div>abc</div>",
    [true],
    {}],
["<div style=display:inline-flex><span>{}<br></span></div><div>abc</div>",
    [["forwarddelete",""]],
    "<div>abc</div>",
    [true],
    {}],
["<div>abc</div><div style=display:flex><span>{}<br></span></div>",
    [["forwarddelete",""]],
    "<div>abc</div><div style=\"display:flex\"><span><br></span></div>",
    [true],
    {}],
["<div>abc</div><div style=display:inline-flex><span>{}<br></span></div>",
    [["forwarddelete",""]],
    "<div>abc</div><div style=\"display:inline-flex\"><span><br></span></div>",
    [true],
    {}],
...
["<div style=display:grid><span>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:inline-grid><span>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-grid\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc</span><span>def[]</span></div>ghi",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-grid><span>abc</span><span>def[]</span></div>ghi",
    [["forwarddelete",""]],
    "<div style=\"display:inline-grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc</span><span>def[]</span></div><div>ghi</div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-grid><span>abc</span><span>def[]</span></div><div>ghi</div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["012[]<div style=display:grid><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "012abc<div style=\"display:grid\"><span>def</span></div>",
    [true],
    {}],
["012[]<div style=display:inline-grid><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "012abc<div style=\"display:inline-grid\"><span>def</span></div>",
    [true],
    {}],
["<div>012[]</div><div style=display:grid><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div>012abc</div><div style=\"display:grid\"><span>def</span></div>",
    [true],
    {}],
["<div>012[]</div><div style=display:inline-grid><span>abc</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div>012abc</div><div style=\"display:inline-grid\"><span>def</span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc</span><span>def[]</span></div><div style=display:grid><span>ghi</span><span>jkl</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abc</span><span>defghi</span></div><div style=\"display:grid\"><span>jkl</span></div>",
    [true],
    {}],
["<div style=display:inline-grid><span>abc</span><span>def[]</span></div><div style=display:inline-grid><span>ghi</span><span>jkl</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-grid\"><span>abc</span><span>defghi</span></div><div style=\"display:inline-grid\"><span>jkl</span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc</span><span>def[]</span></div><div style=display:grid><span>ghi</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:inline-grid><span>abc</span><span>def[]</span></div><div style=display:inline-grid><span>ghi</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:inline-grid\"><span>abc</span><span>defghi</span></div>",
    [true],
    {}],
["<div style=display:grid><span>{}<br></span></div><div>abc</div>",
    [["forwarddelete",""]],
    "<div>abc</div>",
    [true],
    {}],
["<div style=display:inline-grid><span>{}<br></span></div><div>abc</div>",
    [["forwarddelete",""]],
    "<div>abc</div>",
    [true],
    {}],
["<div>abc</div><div style=display:grid><span>{}<br></span></div>",
    [["forwarddelete",""]],
    "<div>abc</div><div style=\"display:grid\"><span><br></span></div>",
    [true],
    {}],
...
["<div style=display:flex><span>abc[]</span><span style=display:contents>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:flex><span>abc[]</span><span style=display:contents><span>def</span></span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:flex><span style=display:contents>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span style=\"display:contents\">abcdef</span></div>",
    [true],
    {}],
["<div style=display:flex><span style=display:contents><span>abc[]</span></span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:flex\"><span style=\"display:contents\"><span>abcdef</span></span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc[]</span><span style=display:contents>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:grid><span>abc[]</span><span style=display:contents><span>def</span></span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span>abcdef</span></div>",
    [true],
    {}],
["<div style=display:grid><span style=display:contents>abc[]</span><span>def</span></div>",
    [["forwarddelete",""]],
    "<div style=\"display:grid\"><span style=\"display:contents\">abcdef</span></div>",
    [true],
    {}],
["<div style=display:grid><span style=display:contents><span>abc[]</span></span><span>def</span></div>",
    [["forwarddelete",""]],
